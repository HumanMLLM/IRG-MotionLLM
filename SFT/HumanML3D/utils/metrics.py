...
import jieba
nltk.data.path.append("/mnt/data1/yuanming/nltk_data")  # 添加自定义路径
try:
    from bert_score import score as score_bert
    BERT_SCORE_AVAILABLE = True
except ImportError:
    BERT_SCORE_AVAILABLE = False
    print("Warning: BERT Score not available. Install with 'pip install bert-score' for BERT score evaluation.")
